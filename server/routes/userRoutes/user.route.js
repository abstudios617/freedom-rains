const {getAllUser, loginUser, addUser, updateUser, deleteAccount, forgotPassword, getOneUserEmail, contactUs} = require('./../../controllers/userControllers/user.controller');
...
module.exports = (app) => {
  ...
  app.post('/users/create', addUser); // creates one user. Requires no params
  ...
  app.delete('/account/delete', authenticateToken,  deleteAccount); // deletes a user. Requires no params
};
